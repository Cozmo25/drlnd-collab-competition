...
To train the agent yourself, please refer to [Tennis_DDPG_2_Agents](./Tennis_DDPG_2_Agents.ipynb) IPython notebook.

The final neural network weights are saved in the following files:

- [Agent 1 Actor](./network_weights/tennis-checkpoint-ddpg-actor-solved-866ep-2-agent_0.pth)
- [Agent 1 Critic](./tennis-checkpoint-ddpg-critic-solved-866ep-2-agent_0.pth)
- [Agent 2 Actor](./tennis-checkpoint-ddpg-actor-solved-866ep-2-agent_1.pth)
